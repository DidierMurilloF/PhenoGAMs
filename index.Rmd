...
The updated linear mixed model predictions are:
...
We also examine the standard errors of the predicted values. Comparing these across models provides insight into how uncertainty is estimated. Despite their different formulations, both GAM and ASReml produce strikingly similar standard errors across genotypes:
...
It is reassuring to see that the uncertainty associated with genotype means is consistently estimated across both models. This further supports the robustness of GAMs as a tool for spatial modeling in plant breeding field trials.
